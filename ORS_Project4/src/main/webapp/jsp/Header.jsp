		...
		<tr>
			...
			<td colspan="2"><font style="font-size: 18px"> <a
				...
				%> <a href="<%=ORSView.MARKSHEET_CTL%>">Add Marksheet</b></a> | <a
					...
					href="<%=ORSView.TIMETABLE_CTL%>">Add TimeTable</b></a> | <%-- <a href="<%=ORSView.BANK_CTL %>">Add Bank</a>    |
        <a href="<%=ORSView.BANK_LIST_CTL%>">Bank List</a>  --%> <a
					href="<%=ORSView.TIMETABLE_LIST_CTL%>">TimeTable List</b></a> | <%--    <a href="<%=ORSView.PRODUCT_CTL%>">Add Product</b></a> | 
        <a href="<%=ORSView.PRODUCT_LIST_CTL%>">Product List</b></a> | 
        
        <a href="<%=ORSView.SALARY_CTL %>">Add Salary</a>    |
        <a href="<%=ORSView.SALARY_LIST_CTL%>">Salary List</a>
        
          <a href="<%=ORSView.ATM_CTL %>">Add ATM</a>    |
        <a href="<%=ORSView.ATM_LIST_CTL%>">ATM List</a>
        
         <a href="<%=ORSView.SUPPORT_CTL%>">Add Support</b></a> | 
        <a href="<%=ORSView.SUPPORT_LIST_CTL%>">Support List</b></a> | --%>

					<a href="<%=ORSView.WISHLIST_CTL%>">Add WishList</b></a> | <a
					href="<%=ORSView.WISHLIST_LIST_CTL%>">Wish List</b></a> | <a
